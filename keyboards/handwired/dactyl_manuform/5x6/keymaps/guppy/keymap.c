...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_5x6(
     ...
     KC_HOME,LCTL(KC_LEFT),KC_UP,LCTL(KC_RIGHT),KC_END,KC_PGUP,               KC_HOME,LCTL(KC_LEFT),KC_UP,LCTL(KC_RIGHT),KC_END,KC_PGUP,
     LALT(KC_LEFT),KC_LEFT,KC_DOWN,KC_RGHT,LALT(KC_RIGHT),KC_PGDN,            LALT(KC_LEFT), KC_LEFT, KC_DOWN, KC_RGHT, LALT(KC_RIGHT),KC_PGDN,
