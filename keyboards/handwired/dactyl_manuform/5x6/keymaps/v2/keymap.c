    ...
    KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                        KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RSFT,
                            KC_LCTL,KC_LGUI,                                        KC_HOME,KC_END,
                                        KC_LALT,KC_SPC,                   KC_ENT, LOWER,
                                            KC_LBRC,KC_UP,            KC_RGHT, KC_MINS,
                                            KC_RBRC,KC_DOWN,          KC_LEFT, KC_EQL
  ),

  [_LOWER] = LAYOUT_5x6(
    KC_F12 , KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 ,                        KC_F6  , KC_F7 , KC_F8 , KC_F9 ,KC_F10 ,KC_F11 ,
    _______,_______,_______,_______,_______,_______,                        KC_HOME,      KC_PGDN,KC_UP,  KC_UP,KC_END,       XXXXXXX,
    ...
    _______,_______,_______,_______,_______,_______,                        XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,
                            _______,MOD_MEH,                                         XXXXXXX,XXXXXXX,
                                        MOD_HYPR,_______,                  _______,_______,
